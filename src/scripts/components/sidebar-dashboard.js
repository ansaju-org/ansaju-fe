  ...
  render() {
    ...
    <aside id="sidebar-drawer" class="fixed top-0 left-0 z-50 flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-[#00bfff]">
        ...
        <div class="flex flex-col justify-between h-full !px-4 !py-4">
            ...
            <!-- Close Button -->
            <button id="closeSidebar" class="flex items-center w-full justify-center !p-2 !mt-4  rounded-lg transition-colors duration-300 text-gray-100">
                <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm7.707-3.707a1 1 0 0 0-1.414 1.414L10.586 12l-2.293 2.293a1 1 0 1 0 1.414 1.414L12 13.414l2.293 2.293a1 1 0 0 0 1.414-1.414L13.414 12l2.293-2.293a1 1 0 0 0-1.414-1.414L12 10.586 9.707 8.293Z" clip-rule="evenodd"/>
                </svg>
                <span class="ml-2 text-base font-medium">Tutup</span>
            </button>
        </div>
    </aside>
    `;
