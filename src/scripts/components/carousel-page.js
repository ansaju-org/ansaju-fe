class CarouselPage extends HTMLElement {
  ...
  render() {
    ...
    <div id="carousel" class="relative justify-items-center px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28">
  <div class="relative mx-auto max-w-7xl">
    <div class="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-3">
      ...
      <div class="flex flex-col overflow-hidden rounded-lg shadow-lg shadow-[#00bfff] transition delay-150 duration-300 ease-in-out hover:-translate-y-1">
        ...
        <div class="flex flex-1 flex-col justify-between bg-[#f8f8f6] p-6">
          <div class="flex-1">
