export default class Register {
  async render() {
    return `
    <section class="flex items-center justify-center min-h-screen bg-[url('/images/bg-right.png')] bg-no-repeat bg-cover p-4">
      <div class="bg-white rounded-3xl border-8 border-[#98e4ae] w-full max-w-md shadow-lg p-8">
        ...
        <form id="registerForm" class="flex flex-col gap-4 items-center">
          <div class="flex flex-col m-[10px] w-9/12">
            ...
            <input type="text" id="name" class="border-2 border-[#98e4ae] rounded-lg p-[10px] focus:outline-none focus:border-green-400 transition" required>
          </div>
          <div class="flex flex-col m-[10px] w-9/12">
            <label for="email" class="text-[#98e4ae] font-League spartan text-lg font-semibold mb-2">Email</label>
            <input type="email" id="email" class="border-2 border-[#98e4ae] rounded-lg p-[10px] focus:outline-none focus:border-green-400 transition" required>
          </div>
          <div class="flex flex-col m-[10px] w-9/12">
            <label for="password" class="text-[#98e4ae] font-League spartan text-lg font-semibold mb-2">Password</label>
            <input type="password" id="password" class="border-2 border-[#98e4ae] rounded-lg p-[10px] focus:outline-none focus:border-green-400 transition" required>
          </div>
