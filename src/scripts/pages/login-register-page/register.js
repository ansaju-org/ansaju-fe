    ...
    <div class="row justify-center">
      <div class="col-12 text-center py-5">
        <div class="pb-5 pt-5 pt-sm-2 text-center">
          ...
          <input class="checkbox hidden" type="checkbox" id="reg-log" name="reg-log" />
          <label for="reg-log" class="cursor-pointer"></label>

          <div class="card-3d-wrap mx-auto relative">
            <div class="card-3d-wrapper relative">
              
              <!-- Card Front -->
              <div class="card-front absolute inset-0 flex items-center justify-center">
                <div class="center-wrap w-full">
                  <div class="text-center">
                    <a href="#" class="inline-block h-20 w-20 relative" target="_blank">
                      <img src="/logo.png" alt="ansaju logo" class="absolute top-0 left-0 z-10">
                    </a>
                    <h4 class="mb-4 pb-3">Log In</h4>
                    <form class="relative" id="login-form">
