       ...
       <h1 class="text-center text-5xl text-[#fff]">Explore to Achieve Your Dreams with Ansaju</h1>
        ...
        <form id="registerForm" class="flex flex-col gap-4 items-center">
          <div class="flex flex-col m-[10px] w-9/12">
            ...
            <input type="text" id="name" class="border-2 border-[#00bfff] rounded-lg p-[10px] focus:outline-none focus:border-[#98e4ae] transition" required>
          </div>
          <div class="flex flex-col m-[10px] w-9/12">
            <label for="email" class="text-[#00bfff] font-League spartan text-lg font-semibold mb-2">Email</label>
            <input type="email" id="email" class="border-2 border-[#00bfff] rounded-lg p-[10px] focus:outline-none focus:border-[#98e4ae] transition" required>
          </div>
          <div class="flex flex-col m-[10px] w-9/12">
